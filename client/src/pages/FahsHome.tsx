        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            <div className="text-right flex-1">
              <h2 className="text-4xl font-bold text-[#18754d] mb-6">
              ...
              <div className="flex gap-4 justify-end">
                {/* Google Play Button */}
                <a href="#" className="bg-white border border-gray-300 rounded-xl px-6 py-3 flex items-center gap-3 hover:shadow-md transition-shadow">
                  <img src="https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg" alt="Google Play" className="h-10" onError={(e) => {
                    e.currentTarget.parentElement!.innerHTML = '<div class="flex items-center gap-2"><svg class="w-8 h-8" viewBox="0 0 24 24"><path fill="#34A853" d="M3.609 1.814L13.792 12 3.61 22.186a.996.996 0 0 1-.61-.92V2.734a1 1 0 0 1 .609-.92z"/><path fill="#FBBC04" d="M20.391 10.186l-3.016-1.757-3.583 3.571 3.583 3.571 3.016-1.757c.875-.51.875-1.118 0-1.628z"/><path fill="#4285F4" d="M3.609 22.186L14.792 12l-1-1-10.183 10.186z"/><path fill="#EA4335" d="M3.609 1.814L14.792 12l-1 1L3.609 1.814z"/></svg><div class="text-right"><div class="text-xs text-gray-500">GET IT ON</div><div class="font-semibold">Google Play</div></div></div>';
                  }} />
                </a>
                {/* App Store Button */}
                <a href="#" className="bg-white border border-gray-300 rounded-xl px-6 py-3 flex items-center gap-3 hover:shadow-md transition-shadow">
                  <img src="https://upload.wikimedia.org/wikipedia/commons/3/3c/Download_on_the_App_Store_Badge.svg" alt="App Store" className="h-10" onError={(e) => {
                    e.currentTarget.parentElement!.innerHTML = '<div class="flex items-center gap-2"><svg class="w-8 h-8" viewBox="0 0 24 24" fill="currentColor"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/></svg><div class="text-right"><div class="text-xs text-gray-500">Download on the</div><div class="font-semibold">App Store</div></div></div>';
                  }} />
                </a>
              </div>
            </div>
